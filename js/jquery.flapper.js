(function($) {
    ...
    Flapper.prototype = {
        ...
        update: function() {
            /* Edit By SBB
            Check for element type.  If "value" attribute does not exist, try
            grabbing innerHtml instead.
             */
            var value = (this.$ele.hasOwnProperty('value')) ? this.$ele.value() : this.$ele.text();
